...
- ✅ **پروفایل پایدار با بانک ژتون**: بای‌این هر میز از دارایی کل کاربر کم می‌شود، برد/باخت به آن برمی‌گردد و هیچ‌کس نمی‌تواند بیشتر از دارایی‌اش وارد بازی شود (ژتون‌ها صرفاً تفریحی‌اند)
- ✅ **بازی با اطرافیان**: با اشتراک موقعیت مکانی، میزهای باز تا شعاع ۳۰ کیلومتری و بازیکنان منتظر اطراف را ببینید و یک‌ضرب بنشینید (`docs/STRATEGY.md` برای نقشه راه)
